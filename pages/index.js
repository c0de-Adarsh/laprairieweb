        ...
        <div className="relative z-20 w-full max-w-7xl mx-auto px-4 flex flex-col lg:flex-row items-center justify-between h-full">
          ...
          >
            ...
            <motion.h1
              ...
              className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-light text-[#FFD700] mb-4 lg:mb-6 tracking-wide leading-tight"
            >
              Most Premium<br />
            ...
            >
              <p className="text-[#FFD700] text-sm md:text-base lg:text-lg mb-2 font-light">
                Order and
              </p>
              <p className="text-[#FFD700] text-sm md:text-base lg:text-lg mb-4 font-light">
                life Chat
              </p>
              <p className="text-[#FFD700] text-lg md:text-xl lg:text-2xl font-medium tracking-wider">
                +41 78 222 44 00
              </p>
            </motion.div>
          </motion.div>
